...
private:
 ...
 public:
    Field( int width, int height, bool My )
    {
        ...
        this->height = height;
        this->My = My;
        this->field = vector<vector<CellFieldStatus>>(height, vector<CellFieldStatus>(width, CellFieldStatus::Unknown));
...
int main(){
    ...
    vector<int> sizes_my = {2, 3};
    Ship_Manager ships_my(sizes_my, 2);
    vector<pair<int, int>> start_coords_my = {{2, 2}, {5, 5}};
    ...
    vector<int> sizes_enemy = {2, 3};
    Ship_Manager ships_enemy(sizes_enemy, 2);
    vector<pair<int, int>> start_coords_enemy = {{2, 2}, {5, 5}};
